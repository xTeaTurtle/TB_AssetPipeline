...
//Name: TB_WoodenMacTruck.0003.ma
//Last modified: Mon, Feb 25, 2019 02:54:36 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.947634212896432 10.699959144193684 48.229670067478438 ;
	setAttr ".r" -type "double3" 4.4616472236169011 2187.7999999979565 -2.2472184362703162e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "55AF0A03-4CB4-EEF2-AF80-0B8E1032A9D7";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 56.219642861496922;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.12543001770973206 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 24 ".pt[140:163]" -type "float3"  0.020596042 0 0.16039792 
		0.060348712 0 0.16039792 0.020596042 0 0.15058628 0.060348712 0 0.15058628 -0.099734619 
		0 0.15058628 -0.099734619 0 0.16039792 -0.099734619 0 -0.16039792 -0.099734619 0 
		-0.15058628 -0.027006272 0 0.16039792 -0.027006272 0 0.15058628 0.099734604 0 0.16039792 
		0.099734619 0 0.15058628 -0.067863576 0 0.16039792 -0.074081309 0 0.15058628 0.060348712 
		0 -0.15058628 0.060348712 0 -0.16039792 0.020596042 0 -0.15058628 0.020596042 0 -0.16039792 
		-0.027006272 0 -0.15058628 -0.027006272 0 -0.16039792 0.099734619 0 -0.15058628 0.099734604 
		0 -0.16039792 -0.074081309 0 -0.15058628 -0.067863576 0 -0.16039792;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode mesh -n "pCubeShape3" -p "pCube3";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.73053452372550964 0.14438720047473907 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[529]" -type "float3" 0 2.5182962e-06 0 ;
	setAttr ".pt[530]" -type "float3" 0 1.296401e-06 0 ;
	setAttr ".pt[531]" -type "float3" 0 1.296401e-06 0 ;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode polyTweak -n "polyTweak62";
	...
	setAttr ".uopa" yes;
	setAttr -s 42 ".tk";
	setAttr ".tk[413]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[414]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[415]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[416]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[417]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[418]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[419]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[420]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[421]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[422]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[423]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[424]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[425]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[426]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[427]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[428]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[429]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[430]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[431]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[432]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[433]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[434]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[435]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[436]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[437]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[438]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[439]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[440]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[441]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[442]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[443]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[444]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[445]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[446]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[447]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[448]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[449]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[450]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[451]" -type "float3" -0.03155493 0 0 ;
	setAttr ".tk[452]" -type "float3" -0.03155493 0 0 ;
...
createNode polyTweak -n "polyTweak63";
	...
	setAttr ".uopa" yes;
	setAttr -s 26 ".tk";
	setAttr ".tk[116]" -type "float3" 0.03204624 -0.21152508 0.079234622 ;
	setAttr ".tk[117]" -type "float3" 0.052648809 -0.20354919 0.07952299 ;
	setAttr ".tk[118]" -type "float3" 0.23617396 0.21152508 0.52101594 ;
	setAttr ".tk[119]" -type "float3" 0.34144473 0.2035494 0.51889074 ;
	setAttr ".tk[120]" -type "float3" 0.010936866 -0.21152508 0.079234622 ;
	setAttr ".tk[121]" -type "float3" 0.080602214 0.21152508 0.52101594 ;
	setAttr ".tk[122]" -type "float3" -0.01434081 -0.21152508 0.079234622 ;
	setAttr ".tk[123]" -type "float3" -0.10568883 0.21152508 0.52101594 ;
	setAttr ".tk[124]" -type "float3" -0.039338484 -0.21152508 0.079234622 ;
	setAttr ".tk[125]" -type "float3" -0.27535906 0.21152508 0.52101594 ;
	setAttr ".tk[126]" -type "float3" -0.052648809 -0.20354919 0.07952299 ;
	setAttr ".tk[127]" -type "float3" -0.34144473 0.2035494 0.51889074 ;
	setAttr ".tk[128]" -type "float3" -0.052648809 -0.20354919 -0.07952299 ;
	setAttr ".tk[129]" -type "float3" -0.34144473 0.2035494 -0.51889074 ;
	setAttr ".tk[130]" -type "float3" 0.052648809 -0.20354919 -0.07952299 ;
	setAttr ".tk[131]" -type "float3" 0.34144473 0.2035494 -0.51889074 ;
	setAttr ".tk[132]" -type "float3" 0.23617396 0.21152508 -0.52101594 ;
	setAttr ".tk[133]" -type "float3" 0.03204624 -0.21152508 -0.079234622 ;
	setAttr ".tk[134]" -type "float3" 0.080602214 0.21152508 -0.52101594 ;
	setAttr ".tk[135]" -type "float3" 0.010936866 -0.21152508 -0.079234622 ;
	setAttr ".tk[136]" -type "float3" -0.10568883 0.21152508 -0.52101594 ;
	setAttr ".tk[137]" -type "float3" -0.01434081 -0.21152508 -0.079234622 ;
	setAttr ".tk[138]" -type "float3" -0.27535906 0.21152508 -0.52101594 ;
	setAttr ".tk[139]" -type "float3" -0.039338484 -0.21152508 -0.079234622 ;
...
// End of TB_WoodenMacTruck.0003.ma
