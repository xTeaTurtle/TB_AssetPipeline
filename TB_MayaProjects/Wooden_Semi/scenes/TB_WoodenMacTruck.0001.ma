...
//Name: TB_WoodenMacTruck.0001.ma
//Last modified: Sun, Feb 24, 2019 10:27:47 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 26.279009774548356 27.572430141833031 50.870527846923956 ;
	setAttr ".r" -type "double3" -14.738352790104599 2901.3999999974399 -1.2810273940698298e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "55AF0A03-4CB4-EEF2-AF80-0B8E1032A9D7";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 60.241053719975916;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.62439167499542236 0.5 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 54 ".pt";
	setAttr ".pt[1]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[3]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[4]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[6]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[8]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[9]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[10]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[11]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[12]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[13]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[14]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[15]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[18]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[19]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[20]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[28]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[29]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[30]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[31]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[35]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[36]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[37]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[38]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[39]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[47]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[48]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[49]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[53]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[55]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[56]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[58]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[60]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[61]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[62]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[63]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[64]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[65]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[66]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[67]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[70]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[71]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[72]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[80]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".pt[81]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[82]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[83]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[87]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[88]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[89]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[90]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[91]" -type "float3" -1.7550178 0 0 ;
	setAttr ".pt[99]" -type "float3" -0.99383843 0 0 ;
	setAttr ".pt[100]" -type "float3" -1.292767 0 0 ;
	setAttr ".pt[101]" -type "float3" -1.7550178 -0.094183907 0 ;
	setAttr ".dr" 1;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode mesh -n "pCubeShape3" -p "pCube3";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.75 0.075000002980232239 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 34 ".pt";
	setAttr ".pt[12]" -type "float3" 0 7.4505806e-09 0.04626403 ;
	setAttr ".pt[13]" -type "float3" 0 7.4505806e-09 -0.04626403 ;
	setAttr ".pt[14]" -type "float3" 0 -3.7252903e-09 0.047308832 ;
	setAttr ".pt[15]" -type "float3" 0 -3.7252903e-09 -0.047308832 ;
	setAttr ".pt[64]" -type "float3" 0 0 -0.010521613 ;
	setAttr ".pt[65]" -type "float3" 0 0 -0.010820933 ;
	setAttr ".pt[66]" -type "float3" 0 0 -0.010820933 ;
	setAttr ".pt[67]" -type "float3" 0 0 -0.010521613 ;
	setAttr ".pt[68]" -type "float3" 0 0 -0.0068379976 ;
	setAttr ".pt[69]" -type "float3" 0 0 6.2713701e-10 ;
	setAttr ".pt[70]" -type "float3" 0 0 0.0068379976 ;
	setAttr ".pt[71]" -type "float3" 0 0 0.010521613 ;
	setAttr ".pt[72]" -type "float3" 0 0 0.010820933 ;
	setAttr ".pt[73]" -type "float3" 0 0 0.010820933 ;
	setAttr ".pt[74]" -type "float3" 0 0 0.010521613 ;
	setAttr ".pt[75]" -type "float3" 0 0 0.0068379976 ;
	setAttr ".pt[76]" -type "float3" 0 0 6.2713701e-10 ;
	setAttr ".pt[77]" -type "float3" 0 0 -0.0068379976 ;
	setAttr ".pt[78]" -type "float3" 0 0 0.010949651 ;
	setAttr ".pt[79]" -type "float3" 0 0 0.011261146 ;
	setAttr ".pt[80]" -type "float3" 0 0 0.011261146 ;
	setAttr ".pt[81]" -type "float3" 0 0 0.010949651 ;
	setAttr ".pt[82]" -type "float3" 0 0 -0.036872808 ;
	setAttr ".pt[83]" -type "float3" 0 0 0.0071161781 ;
	setAttr ".pt[84]" -type "float3" 0 0 6.5265005e-10 ;
	setAttr ".pt[85]" -type "float3" 0 0 -0.0071161781 ;
	setAttr ".pt[86]" -type "float3" 0 0 0.036872808 ;
	setAttr ".pt[87]" -type "float3" 0 0 -0.010949651 ;
	setAttr ".pt[88]" -type "float3" 0 0 -0.011261146 ;
	setAttr ".pt[89]" -type "float3" 0 0 -0.011261146 ;
	setAttr ".pt[90]" -type "float3" 0 0 -0.010949651 ;
	setAttr ".pt[91]" -type "float3" 0 0 -0.0071161781 ;
	setAttr ".pt[92]" -type "float3" 0 0 6.5265005e-10 ;
	setAttr ".pt[93]" -type "float3" 0 0 0.0071161781 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
connectAttr "polyDelEdge18.out" "pCubeShape2.i";
...
// End of TB_WoodenMacTruck.0001.ma
